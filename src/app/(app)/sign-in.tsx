    ...
    <SafeAreaView className='flex-1'>
        <KeyboardAvoidingView 
            ...
            <View className=' flex-1 px-6'>
              ...
              <TouchableOpacity
                className='bg-white rounded-xl py-4 mb-4 shadow-lg shadow-gray-200'
                onPress={signInWithGoogle}
                activeOpacity={0.8}
              >
                <View className='flex-row items-center justify-center'>
                  <Ionicons name="logo-google" size={24} color="#F54927" className='self-center'/>
                  <Text className='text-gray-900 text-center text-lg font-semibold ml-2'>
                    Sign In with Google
                  </Text>
                </View>
              </TouchableOpacity>
